    ...
    public void doGet(HttpServletRequest request,HttpServletResponse response) throws IOException {
        try {
            ...
            try(Writer writer = response.getWriter()) {
                ...
                writer.write("<h1>Welcome to My Online Bookstore</h1>\n");

                writer.write("<table width='55%' border='0' cellpadding=4>");
                for(int i=0; i<books.size(); i++) {//单双行变色
                    ...
                    writer.write(String.format("<td><a href='./updateBook?id=%s'修改</a></td>", book.getId()));
                    writer.write("</tr>");
                }
